  ...
  return (
    <div id="bo_list_wrap" className="mb-4">
      ...
      >
        ...
        <div
          id="bo_btn_top"
          className="clearfix f-de font-weight-normal mb-2 pl-3 pr-2 px-sm-0"
        >
          <div className="d-flex align-items-center">
            ...
            <div className="btn-group" role="group">
              ...
              <div className="btn-group" role="group">
                ...
                >
                  <i
                    className="fa fa-sort-numeric-desc fa-md"
                    aria-hidden="true"
                  ></i>
        ...
        <section id="bo_list" className="mb-4">
          {/* <!-- 목록 헤드 --> */}
          <div
            className="d-block d-md-none w-100 mb-0 bg-primary"
            style={{ height: "4px" }}
          ></div>
          ...
          <ul className="na-table d-md-table w-100">
            <li className="d-md-table-row px-3 py-2 p-md-0 text-md-center text-muted border-bottom bg-light">
              ...
              <div className="d-md-table-cell text-left py-md-2 pr-md-1">
                <div className="na-title float-md-left">
                  <div className="na-item">
                    <a
                      href="https://cagongtv.com/community/1"
                      className="na-subject"
                    >
                      <span className="na-icon na-hot"></span>
                      <strong>
                        자유토크 <span className="na-bar"></span> 카공 커뮤니티
                        게시판 이용가이드 안내
                      </strong>
                    </a>
                  </div>
              ...
              <div className="float-left float-md-none d-md-table-cell nw-3 nw-md-auto f-sm font-weight-normal py-md-2 pr-md-1">
                <i
                  className="fa fa-thumbs-o-up d-md-none"
                  aria-hidden="true"
                ></i>
              ...
              <div className="float-left float-md-none d-md-table-cell nw-3 nw-md-auto f-sm font-weight-normal py-md-2 pr-md-1">
                <i
                  className="fa fa-thumbs-o-down d-md-none"
                  aria-hidden="true"
                ></i>
